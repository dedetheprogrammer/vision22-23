...
options_canvas.create_window(-20, 20, anchor=tk.NW, window=none_option)
# -- Contraste
contrast_option = tk.Radiobutton(options_canvas, text='Contraste y brillo', width=25,value=1, variable=selected_effect)
options_canvas.create_window(1, 50, anchor=tk.NW, window=contrast_option)
bar_contrast    = tk.Scale(options_canvas, variable=tk.DoubleVar(value=1.0), from_=-3, to=3, resolution=0.1, length=255, orient=tk.HORIZONTAL,state='disabled', troughcolor=disabled_color)
options_canvas.create_window(64, 70, anchor=tk.NW, window=bar_contrast)
bar_brightness  = tk.Scale(options_canvas, variable=tk.IntVar(value=0), from_=-512, to=512, length=255, orient=tk.HORIZONTAL, state='disabled', troughcolor=disabled_color)
options_canvas.create_window(64, 125, anchor=tk.NW, window=bar_brightness)
...
options_canvas.create_window(28, 180, anchor=tk.NW, window=equalize_option)
# -- Alien
alien_option = tk.Radiobutton(options_canvas, text='Alien', width=25,value=3, variable=selected_effect)
options_canvas.create_window(-30, 210, anchor=tk.NW, window=alien_option)
...
options_canvas.create_window(64, 240, anchor=tk.NW, window=bar_R)
...
options_canvas.create_window(64, 300, anchor=tk.NW, window=bar_G)
...
options_canvas.create_window(64, 360, anchor=tk.NW, window=bar_B)
# -- Poster
...
options_canvas.create_window(-27, 430, anchor=tk.NW, window=poster_option)
...
options_canvas.create_window(64, 460, anchor=tk.NW, window=bar_clusters)
checkbox_more_precission = tk.Checkbutton(root, text="Más precisión", variable=more_precission, state='disabled')
options_canvas.create_window(62, 530, anchor=tk.NW, window=checkbox_more_precission)

# -- Distorsion
distorsion_option = tk.Radiobutton(options_canvas, text='Distorsion', width=25,value=5, variable=selected_effect)
options_canvas.create_window(-20, 570, anchor=tk.NW, window=distorsion_option)
...
options_canvas.create_window(64, 600, anchor=tk.NW, window=bar_coefficient)
...
options_canvas.create_window(64, 660, anchor=tk.NW, window=bar_x_center_pos)
...
options_canvas.create_window(64, 720, anchor=tk.NW, window=bar_y_center_pos)
